export default function NavigationDesktop({
  ...
  return (
    <nav className="max-md:hidden flex items-center gap-8">
      ...
      <a
        href="#simulacao"
        className={`font-bold px-5 py-2 rounded-full transition-all ${isScrolled ? "bg-purple-600 text-white hover:bg-purple-700" : "bg-white text-purple-600 hover:bg-gray-100"}`}
      >
        Simulação
      </a>
    </nav>
